 ...
 */
public class ButtonEventGeheRechts extends ButtonEvent{
     ...
     */
    public ButtonEventGeheRechts(RindMitRichtungsSinn rindVieh){
        super(rindVieh);
    }

    /**
     * Überlädt die Methode {@link ButtonEvent#eventRindVieh()} aus der geerbten Klasse {@link ButtonEvent}.
     * und lässt das Rind sich nach Osten drehen und danach ein Feld nach vorn.
     */
    @Override
    public void eventRindVieh() {
        rindVieh.setRichtung(Rindvieh.RichtungsTyp.OST);
        rindVieh.geheVor();
    }
}
